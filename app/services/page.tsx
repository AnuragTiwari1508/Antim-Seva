            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <p className="text-gray-600 text-sm md:text-base mb-6 leading-relaxed text-left">{service.description}</p>
                    ...
                    <button className="mt-3 p-2 w-full rounded-lg border bg-green-600 text-white flex flex-col justify-between"><a href="https://wa.me/9179677292">Contact</a></button>
                  </div>
                </div>
              ))}
            </div>
