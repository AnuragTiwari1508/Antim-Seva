  ...
  const providers = [
    {
      ...
      charges: "₹2000 - ₹4000",
      contact: "987340XXXX",
      image: "https://5.imimg.com/data5/PV/PO/CJ/SELLER-95328874/wedding-band-services-500x500.jpg",
      services: [
        "Wedding Procession",
        "Dhol & Tasha",
        "Brass Instruments",
    ...
    {
      id: 2,
      name: "Maharaja Band Baja",
      experience: 10,
      location: "Bhopal, M.P.",
      charges: "₹3000 - ₹5,000",
      contact: "9876543XXX",
      image: "https://millan.co.in/backend/images/admin-service/62ee53fe620381659786238.jpg",
      services: [
        "Ghodi Sawari",
        "Shehnai Performance",
        "Wedding Lights",
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 bg-amber-50">
        ...
        >
          Our Band Baja Services bring music, energy, and grandeur to your special events. 
          From wedding processions to festive occasions, our affiliated bands ensure a vibrant and joyful experience with traditional as well as modern instruments.
        </motion.p>
          ...
          {providers.map((provider) => (
            ...
            >
              ...
              <div className="p-4 md:w-2/3 flex flex-col flex-grow">
                ...
                <p className="text-sm text-gray-600">Contact: {provider.contact}</p>
                ...
                >
                  <a href={`https://wa.me/91${provider.contact}?text=I want to book ${provider.name} Band Baja`}>
                    Book Now
                  </a>
                </motion.button>
              </div>
      ...
      {isPopupOpen && (
        <div className="fixed inset-0 bg-black/60 flex justify-center items-center z-50">
          <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-lg relative mx-2">
            ...
            <h3 className="text-xl font-semibold mb-4">Register as Band Baja Provider</h3>
            <form className="space-y-4">
              <input type="text" placeholder="Full Name" className="w-full p-2 border rounded-lg" />
              <input type="text" placeholder="Band / Group Name" className="w-full p-2 border rounded-lg" />
              ...
              <input type="text" placeholder="Charges Range" className="w-full p-2 border rounded-lg" />
              <input type="text" placeholder="Contact Number" className="w-full p-2 border rounded-lg" />
