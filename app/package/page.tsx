...
export default function PackagePage() {
  ...
  const handlePackageSelect = (packageData: any) => {
    // Add package to cart immediately
    const packageItem = {
      id: `package-${packageData.name.toLowerCase().replace(/\s+/g, '-')}`,
    ...
    // Store package data for product page
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8">
              Our experts are available 24/7 to help you select the right package
              <br />
              <span className="text-gray-700">हमारे विशेषज्ञ 24/7 उपलब्ध हैं</span>
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="tel:+919179677292"
                className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-lg font-bold transition inline-flex items-center justify-center"
              >
